...
timer 		clear
timer 		on 1
use 		"${datadir}\1-data\linktable.dta", clear
...
**************************** MERGE IN GROUP ************************************
merge 1:1 studyid1 using "${datadir}\1-Data\all\basicinfo.dta"
...
preserve
keep if 	trial ==1
save		"${datadir}\1-data\idsandtrialgroups_trial1.dta", replace
cap drop	_merge
restore
preserve
keep if 	trial ==3 															// remember: there is no trial 2 (- thats within trial 1)
save		"${datadir}\1-data\idsandtrialgroups_trial3.dta", replace
cap drop	_merge
restore
preserve
keep if 	trial ==4
save		"${datadir}\1-data\idsandtrialgroups_trial4.dta", replace
cap drop	_merge
restore
preserve
keep if 	trial ==5
save		"${datadir}\1-data\idsandtrialgroups_trial5.dta", replace
cap drop	_merge
restore
preserve
keep if 	trial ==6
save		"${datadir}\1-data\idsandtrialgroups_trial6.dta", replace
cap drop	_merge
restore
preserve
keep if 	trial ==7
save		"${datadir}\1-data\idsandtrialgroups_trial7.dta", replace
cap drop	_merge
restore
preserve
keep if 	trial ==8
save		"${datadir}\1-data\idsandtrialgroups_trial8.dta", replace
cap drop	_merge
restore
preserve
keep if 	trial ==9
save		"${datadir}\1-data\idsandtrialgroups_trial9.dta", replace
cap drop	_merge
restore
*===============================================================================
timer		off 1
